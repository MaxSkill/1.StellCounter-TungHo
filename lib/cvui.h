...
/**
 Display an image in the specified window and update the internal structures of cvui.bool button(
...
*/
bool button(cv::Mat& theWhere, int theX, int theY, const cv::String& theLabel, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont);
...
/**
 ...
 \return `true` everytime the user clicks the button.
*/
bool button(cv::Mat& theWhere, int theX, int theY, int theWidth, int theHeight, const cv::String& theLabel, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont);
...
/**
 ...
 \sa iarea()
*/
bool button(cv::Mat& theWhere, int theX, int theY, cv::Mat& theIdle, cv::Mat& theOver, cv::Mat& theDown, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont);
...
/**
 ...
 \sa endColumn()
*/
bool button(int theWidth, int theHeight, const cv::String& theLabel, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont);
...
/**
 ...
 \sa endColumn()
*/
bool button(const cv::String& theLabel, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont);
...
/**
 ...
 \sa endColumn()
*/
bool button(cv::Mat& theIdle, cv::Mat& theOver, cv::Mat& theDown, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont);
...
namespace internal
{
	...
	int iarea(int theX, int theY, int theWidth, int theHeight);
	bool button(cvui_block_t& theBlock, int theX, int theY, int theWidth, int theHeight, const cv::String& theLabel, bool theUpdateLayout, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont);
	bool button(cvui_block_t& theBlock, int theX, int theY, const cv::String& theLabel, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont);
	bool button(cvui_block_t& theBlock, int theX, int theY, cv::Mat& theIdle, cv::Mat& theOver, cv::Mat& theDown, bool theUpdateLayout, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont);
...
namespace render {
	...
	void button(cvui_block_t& theBlock, int theState, cv::Rect& theShape, const cv::String& theLabel, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont);
	void buttonLabel(cvui_block_t& theBlock, int theState, cv::Rect theRect, const cv::String& theLabel, cv::Size& theTextSize, cv::Scalar colorFont);
...
namespace internal
{
	...
	bool button(cvui_block_t& theBlock, int theX, int theY, int theWidth, int theHeight, const cv::String& theLabel, bool theUpdateLayout, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont) {
		...
		render::button(theBlock, aStatus, aRect, theLabel, color1, color2, color3, colorFont);
		render::buttonLabel(theBlock, aStatus, aRect, theLabel, aTextSize, colorFont);
	...
	bool button(cvui_block_t& theBlock, int theX, int theY, const cv::String& theLabel, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont) {
		...
		return internal::button(theBlock, theX, theY, aTextSize.width + 30, aTextSize.height + 18, theLabel, true, color1, color2, color3, colorFont);
	}
	...
	int counter(cvui_block_t& theBlock, int theX, int theY, int *theValue, int theStep, const char *theFormat) {
		...
		if (internal::button(theBlock, theX, theY, 22, 22, "-", false, cv::Scalar(255, 224, 192), cv::Scalar(0x52, 0x52, 0x52), cv::Scalar(0x52, 0x52, 0x52), cv::Scalar(0, 0, 0))) {
			*theValue -= theStep;
		}
		...
		if (internal::button(theBlock, aContentArea.x + aContentArea.width, theY, 22, 22, "+", false, cv::Scalar(192, 192, 255), cv::Scalar(0x52, 0x52, 0x52), cv::Scalar(0x52, 0x52, 0x52), cv::Scalar(0, 0, 0))) {
			*theValue += theStep;
		}
	...
	double counter(cvui_block_t& theBlock, int theX, int theY, double *theValue, double theStep, const char *theFormat) {
		cv::Rect aContentArea(theX + 22, theY, 30, 22);
...
namespace render
{
	...
	void button(cvui_block_t& theBlock, int theState, cv::Rect& theShape, const cv::String& theLabel, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont) {
		...
		theShape.x++; theShape.y++; theShape.width -= 2; theShape.height -= 2;
			...
			cv::rectangle(theBlock.where, theShape, theState == OUT ? color1 : (theState == OVER ? color2 : color3), CVUI_FILLED);
	...
	void window(cvui_block_t& theBlock, cv::Rect& theTitleBar, cv::Rect& theContent, const cv::String& theTitle) {
		...
		if (aTransparecy) {
			...
			cv::rectangle(theBlock.where, theContent, cv::Scalar(0,0,0), CVUI_FILLED);
		}
	}
...
bool button(cv::Mat& theWhere, int theX, int theY, const cv::String& theLabel, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont) {
	...
	return internal::button(internal::gScreen, theX, theY, theLabel, color1, color2, color3, colorFont);
}

bool button(cv::Mat& theWhere, int theX, int theY, int theWidth, int theHeight, const cv::String& theLabel, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont) {
	internal::gScreen.where = theWhere;
	return internal::button(internal::gScreen, theX, theY, theWidth, theHeight, theLabel, true, color1, color2, color3, colorFont);
}

bool button(cv::Mat& theWhere, int theX, int theY, cv::Mat& theIdle, cv::Mat& theOver, cv::Mat& theDown, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont) {
	internal::gScreen.where = theWhere;
	return internal::button(internal::gScreen, theX, theY, theIdle, theOver, theDown, true, color1, color2, color3, colorFont);
}
...
bool button(const cv::String& theLabel, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont) {
	cvui_block_t& aBlock = internal::topBlock();
	return internal::button(aBlock, aBlock.anchor.x, aBlock.anchor.y, theLabel, color1, color2, color3, colorFont);
}

bool button(int theWidth, int theHeight, const cv::String& theLabel, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont) {
	cvui_block_t& aBlock = internal::topBlock();
	return internal::button(aBlock, aBlock.anchor.x, aBlock.anchor.y, theWidth, theHeight, theLabel, true, color1, color2, color3, colorFont);
}

bool button(cv::Mat& theIdle, cv::Mat& theOver, cv::Mat& theDown, cv::Scalar color1, cv::Scalar color2, cv::Scalar color3, cv::Scalar colorFont) {
	cvui_block_t& aBlock = internal::topBlock();
	return internal::button(aBlock, aBlock.anchor.x, aBlock.anchor.y, theIdle, theOver, theDown, true, color1, color2, color3, colorFont);
}
